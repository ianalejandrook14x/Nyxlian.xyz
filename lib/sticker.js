...
async function sticker3(img, url, botname, author) {
...
async function sticker5(img, url, botname, author, categories = [''], extra = {}) {
...
async function addExif(webpSticker, botname, author, categories = [''], extra = {}) {
  const img = new webp.Image();
  const stickerPackId = crypto.randomBytes(32).toString('hex');
  const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': botname, 'sticker-pack-publisher': author, "android-app-store-link": "https://play.google.com/store/apps/details?id=com.marsvard.stickermakerforwhatsapp", "ios-app-store-link": "https://itunes.apple.com/app/sticker-maker-studio/id1443326857", 'emojis': categories, ...extra };
